...
// Chaning the code to remove scolling and add the demo into loop() so that it can be run continuously
...
void testdrawbitmap(const uint8_t *bitmap, uint8_t w, uint8_t h) {
  ...
  uint8_t counter = 99;  // Make it run counter number of times
