    ...
    *********************************************************************/
    ...
    // // startscrollleft
    // // Activate a right handed scroll for rows start through stop
    // void Adafruit_SH1106::startscrollleft(uint8_t start, uint8_t stop, uint8_t cursor_x, uint8_t cursor_y){
    //     if (start > SH1106_LCDWIDTH || stop > SH1106_LCDWIDTH) {
    //         start = SH1106_LCDWIDTH;
    //         stop = SH1106_LCDWIDTH;
    //     }
    ...
    // void Adafruit_SH1106::startscrolldiagright(uint8_t start, uint8_t stop, uint8_t cursor_x, uint8_t cursor_y){
    ...
    // // startscrolldiagleft
    // // Activate a diagonal scroll for rows start through stop
    // void Adafruit_SH1106::startscrolldiagleft(uint8_t start, uint8_t stop, uint8_t cursor_x, uint8_t cursor_y){
    //     if (start > SH1106_LCDHEIGHT || stop > SH1106_LCDHEIGHT) {
    //         start = SH1106_LCDHEIGHT;
    //         stop = SH1106_LCDHEIGHT;
    //     }
